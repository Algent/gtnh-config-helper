...
def main():
    ...
    parser.add_argument('-i', '--instance-path', help='Path to instance or server to configure')
...
# TODO Function to replace into strings into a file taking path, search and replace
